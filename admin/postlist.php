        ...
        <div class="block">  
			...
			<tbody>
				...
				<tr class="odd gradeX">
					...
					<td>
						<a href="editpostid.php?editpostid=<?php echo $result['id']; ?>">Edit</a> 
						|| 
						<a onclick="return confirm('Are you sure to Delete!');" href="delpostid.php?delpostid=<?php echo $result['id']; ?>">Delete</a>
				</tr>
				<?php } } ?>
			</tbody>
		</table>
